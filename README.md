...
What's unique:
- the way that it bootstraps (i.e. the way it lazy loads, tries to avoid a single point of entry like in many other Client Frameworks such as main())
- Start at the root then enter Layouts
- Ability to quickly get up and running with Service Workers.
